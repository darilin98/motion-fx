...
Inside the controller, lives the video pipeline. It consists of two distinct parts.
...
The results of the extractors are transmitted to the processor through the means of VST parameters.
